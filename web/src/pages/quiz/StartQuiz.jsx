  ...
  return (
    <BaseLayout>
      <div className="text-black px-12 pt-12 mb-0 pb-0 text-xl">
        <h2 className="text-center text-2xl mb-8">Brief Explanation About this Quiz</h2>
        <section className="mb-9">
          <p className="mb-4"><span className="font-extrabold">Number of Questions:</span> {item.no_questions}</p>
          <p><span className="font-extrabold ">Time:</span> {convertTime(item.time)}</p>
        </section>
        <main>
          <h4 className="mb-9">Please read the text carefully so you can understand it</h4>
